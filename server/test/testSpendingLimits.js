...
describe("Spending Limit tests", () => {
    ...
    describe("API tests", () => {
      ...
      beforeEach(async() => {
        ...
        otherSpendingLimit = await SpendingLimit.create({...OTHER_SPENDING_LIMIT, userId: otherUser._id, categoryId: otherCategory._id});
        ...
        spendingLimit = await SpendingLimit.create({...SPENDING_LIMIT, userId: user._id, categoryId: category._id});
      });
      ...
      it("should get spending limits belonging to the user", async() => {
        ...
        //res.body[0].should.have.property("duration", spendingLimit.duration);
      ...
      it("should get a summary of limits");
      ...
      it("should post a valid spending limit", async() => {
        ...
        res.body.should.have.property("duration", {type: "WEEK"});
      });
      ...
      it("should get a specific spending limit", async() => {
        ...
        res.body.should.have.property("name", spendingLimit.title);
        res.body.should.have.property("duration", spendingLimit.description);
      ...
      it("should prevent the user from getting a spending limit of a different user", async() => {
        ...
        assertError(res, 403);
        should.not.exist(res.body, "Should not have gotten a spending limit");
      });
      ...
      it("should delete a specified spending limit", async() => {
        ...
        should.not.exist(resPost.body, "Spending Limit should have been deleted");
      });
      ...
      it("should prevent the user from deleting another user's spending limit", async() => {
        ...
        resPost.body.should.have.property("name", otherSpendingLimit.name);
        resPost.body.should.have.property("duration", otherSpendingLimit.duration);
        resPost.body.should.have.property("amount", otherSpendingLimit.amount);
      });
      ...
      it("should update a specified spending limit", async() => {
        ...
        res.body.should.have.property("duration", spendingLimit.duration);
        res.body.should.have.property("amount", spendingLimit.amount);
        ...
        resPost.should.have.status(200);
        resPost.should.have.property("body");
        resPost.body.should.have.property("name", "grocery limit");
        resPost.body.should.have.property("duration", {type: 'WEEK'});
